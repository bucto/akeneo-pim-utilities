...
$categoryCodes = ['series_name_acies', 'series_name_acies_aj', 'series_name_acies_aje', 'series_name_apelio', 'series_name_apelio_2', 'series_name_apelio_3', 'series_name_coma_plasma', 'series_name_c1_aj', 'series_name_lc_c1_aje', 'series_name_lc_c1', 'series_name_eml', 'series_name_eml_pdc', 'series_name_eml_aj_pdc', 'series_name_eml_aj', 
'series_name_eml_aje']; // Beispiel mit mehreren Kategorien
